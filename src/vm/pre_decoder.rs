...
//         insert!("ADD_U64", Operations::add_u64, OPERANDS_TWO_VALUES);
//         insert!("ADD_U64_IMMEDIATE", Operations::add_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("ADD_I64", Operations::add_i64, OPERANDS_TWO_VALUES);
//         insert!("ADD_I64_IMMEDIATE", Operations::add_i64_immediate, OPERANDS_TWO_VALUES);
//         insert!("SUB_U64", Operations::sub_u64, OPERANDS_TWO_VALUES);
//         insert!("SUB_U64_IMMEDIATE", Operations::sub_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("SUB_I64", Operations::sub_i64, OPERANDS_TWO_VALUES);
//         insert!("SUB_I64_IMMEDIATE", Operations::sub_i64_immediate, OPERANDS_TWO_VALUES);
//         insert!("MUL_U64", Operations::mul_u64, OPERANDS_TWO_VALUES);
//         insert!("MUL_U64_IMMEDIATE", Operations::mul_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("MUL_I64", Operations::mul_i64, OPERANDS_TWO_VALUES);
//         insert!("MUL_I64_IMMEDIATE", Operations::mul_i64_immediate, OPERANDS_TWO_VALUES);
//         insert!("DIV_U64", Operations::div_u64, OPERANDS_TWO_VALUES);
//         insert!("DIV_U64_IMMEDIATE", Operations::div_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("DIV_I64", Operations::div_i64, OPERANDS_TWO_VALUES);
//         insert!("DIV_I64_IMMEDIATE", Operations::div_i64_immediate, OPERANDS_TWO_VALUES);
//         insert!("ABS", Operations::abs, OPERANDS_TWO_VALUES);
//         insert!("MOD_I64", Operations::mod_i64, OPERANDS_TWO_VALUES);
//         insert!("NEG_I64", Operations::neg_i64, OPERANDS_TWO_VALUES);
//         insert!("U64_TO_F64", Operations::u64_to_f64, OPERANDS_TWO_VALUES);
//         insert!("I64_TO_F64", Operations::i64_to_f64, OPERANDS_TWO_VALUES);
//         insert!("ADD_F64", Operations::add_f64, OPERANDS_TWO_VALUES);
//         insert!("ADD_F64_IMMEDIATE", Operations::add_f64_immediate, OPERANDS_TWO_VALUES);
//         insert!("SUB_F64", Operations::sub_f64, OPERANDS_TWO_VALUES);
//         insert!("SUB_F64_IMMEDIATE", Operations::sub_f64_immediate, OPERANDS_TWO_VALUES);
//         insert!("MUL_F64", Operations::mul_f64, OPERANDS_TWO_VALUES);
//         insert!("MUL_F64_IMMEDIATE", Operations::mul_f64_immediate, OPERANDS_TWO_VALUES);
//         insert!("DIV_F64", Operations::div_f64, OPERANDS_TWO_VALUES);
//         insert!("DIV_F64_IMMEDIATE", Operations::div_f64_immediate, OPERANDS_TWO_VALUES);
//         insert!("ABS_F64", Operations::abs_f64, OPERANDS_TWO_VALUES);
//         insert!("NEG_F64", Operations::neg_f64, OPERANDS_TWO_VALUES);
//         insert!("TO_I64", Operations::to_i64, OPERANDS_TWO_VALUES);
//         insert!("AND_U64", Operations::and_u64, OPERANDS_TWO_VALUES);
//         insert!("AND_U64_IMMEDIATE", Operations::and_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("OR_U64", Operations::or_u64, OPERANDS_TWO_VALUES);
//         insert!("OR_U64_IMMEDIATE", Operations::or_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("XOR_U64", Operations::xor_u64, OPERANDS_TWO_VALUES);
//         insert!("XOR_U64_IMMEDIATE", Operations::xor_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("NOT_U64", Operations::not_u64, OPERANDS_TWO_VALUES);
//         insert!("SHL_U64", Operations::shl_u64, OPERANDS_TWO_VALUES);
//         insert!("SHL_U64_IMMEDIATE", Operations::shl_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("SHL_I64", Operations::shl_i64, OPERANDS_TWO_VALUES);
//         insert!("SHL_I64_IMMEDIATE", Operations::shl_i64_immediate, OPERANDS_TWO_VALUES);
//         insert!("SHR_U64", Operations::shr_u64, OPERANDS_TWO_VALUES);
//         insert!("SHR_U64_IMMEDIATE", Operations::shr_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("SHR_I64", Operations::shr_i64, OPERANDS_TWO_VALUES);
//         insert!("SHR_I64_IMMEDIATE", Operations::shr_i64_immediate, OPERANDS_TWO_VALUES);
//         insert!("ROL_U64", Operations::rol_u64, OPERANDS_TWO_VALUES);
//         insert!("ROL_U64_IMMEDIATE", Operations::rol_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("ROL_I64", Operations::rol_i64, OPERANDS_TWO_VALUES);
//         insert!("ROL_I64_IMMEDIATE", Operations::rol_i64_immediate, OPERANDS_TWO_VALUES);
//         insert!("ROR_U64", Operations::ror_u64, OPERANDS_TWO_VALUES);
//         insert!("ROR_U64_IMMEDIATE", Operations::ror_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("ROR_I64", Operations::ror_i64, OPERANDS_TWO_VALUES);
//         insert!("ROR_I64_IMMEDIATE", Operations::ror_i64_immediate, OPERANDS_TWO_VALUES);
//         insert!("COUNT_ONES_U64", Operations::count_ones_u64, OPERANDS_TWO_VALUES);
//         insert!("COUNT_ZEROS_U64", Operations::count_zeros_u64, OPERANDS_TWO_VALUES);
//         insert!("TRAILING_ZEROS_U64", Operations::trailing_zeros_u64, OPERANDS_TWO_VALUES);
//         insert!("MOV", Operations::mov, OPERANDS_TWO_VALUES);
//         insert!("LOAD_U64_IMMEDIATE", Operations::load_u64_immediate, OPERANDS_TWO_VALUES);
//         insert!("SWAP", Operations::swap, OPERANDS_TWO_VALUES);
//         insert!("JUMP", Operations::jump, OPERANDS_TWO_VALUES);
//         insert!("EQ_JUMP", Operations::eq_jump, OPERANDS_PACK3_VALUE);
//         insert!("NEQ_JUMP", Operations::neq_jump, OPERANDS_PACK3_VALUE);
//         insert!("LT_U64_JUMP", Operations::lt_u64_jump, OPERANDS_PACK3_VALUE);
//         insert!("LTE_U64_JUMP", Operations::lte_u64_jump, OPERANDS_PACK3_VALUE);
//         insert!("LT_I64_JUMP", Operations::lt_i64_jump, OPERANDS_PACK3_VALUE);
//         insert!("LTE_I64_JUMP", Operations::lte_i64_jump, OPERANDS_PACK3_VALUE);
//         insert!("GT_U64_JUMP", Operations::gt_u64_jump, OPERANDS_PACK3_VALUE);
//         insert!("GTE_U64_JUMP", Operations::gte_u64_jump, OPERANDS_PACK3_VALUE);
//         insert!("GT_I64_JUMP", Operations::gt_i64_jump, OPERANDS_PACK3_VALUE);
//         insert!("GTE_I64_JUMP", Operations::gte_i64_jump, OPERANDS_PACK3_VALUE);
//         insert!("CALL", Operations::call, OPERANDS_TWO_VALUES);
//         insert!("RET", Operations::ret, OPERANDS_NONE);
//         insert!("PRINT_U64", Operations::print_u64, OPERANDS_TWO_VALUES);
//         insert!("ALLOC", Operations::alloc, OPERANDS_PACK2_VALUE);
//         insert!("REALLOC", Operations::realloc, OPERANDS_TWO_VALUES);
//         insert!("DEALLOC", Operations::dealloc, OPERANDS_TWO_VALUES);
//         insert!("EXIT", Operations::exit, OPERANDS_TWO_VALUES);
//         insert!("LOAD_U64", Operations::load_u64, OPERANDS_PACK3_VALUE);
...
//     #[test]
//     fn decode_sample_program() {
//         let source = r#"
// MAIN    ; entry point
// ALLOC 3 8
// ADD_U64_IMMEDIATE 1 1
// LOAD_U64_IMMEDIATE 2 1000000000
// STORE_U64 0x00030000 0
// ATOMIC_ADD_U64 0x08030001 0
// ATOMIC_LOAD_U64 0x00030004 0
// LT_U64_JUMP 0x000402 4
// PRINT_U64 4 0
// EXIT 0 0
...
//         assert_eq!(main[0].a, 3);
//         assert_eq!(main[0].b, 8);
//         assert_eq!(main[5].a, 0x00030004);
//         assert_eq!(main[5].b, 0);

//         let call_opcode = decoder
//             .decode("MAIN\nCALL FUNC1\nEXIT 0 0\n\nFUNC1\nRET\n")
//             .expect("call decode succeeds");
//         assert_eq!(call_opcode.len(), 2);
//         let call_ins = &call_opcode[0].instructions[0];
//         assert_eq!(call_ins.a, 1); // FUNC1 index
//         assert_eq!(call_ins.b, 0);
//     }

//     #[test]
//     fn missing_main_is_error() {
//         let decoder = PreDecoder::new();
//         let result = decoder.decode("FUNC1\nRET\n");
//         assert!(matches!(result, Err(PreDecodeError::MissingMain)));
//     }

//     #[test]
//     fn registers_can_be_referenced_with_prefix() {
//         let source = r#"
// MAIN
...
//         assert_eq!(functions.len(), 2);
//         let main = &functions[0].instructions;
//         assert_eq!(main[0].a, 1); // r1
//         assert_eq!(main[1].a, 1); // dest r1
//         assert_eq!(main[1].b, 2); // src r2
//     }
// }
